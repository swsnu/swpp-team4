...
const snippetReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case 'LIKE_SNIPPET':
            return {
                ...state, likedSnippetList: [...state.likedSnippetList, action.data],
            };
        case 'UNLIKE_SNIPPET':
            ...
            return {
                ...state, likedSnippetList: newLikeList,
            };
        ...
        case 'ADD_SHARED_SNIPPET':
            return {
                ...state, sharedSnippetList: [...state.sharedSnippetList, action.data]
            };
        case 'DELETE_SHARED_SNIPPET':
            ...
            return {
                ...state, sharedSnippetList: newList
            };
        default:
            break;
    }
